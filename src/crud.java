...
public class crud {
    public static void main(String[] args) {
        ...
        try {
            ...
            stmt.executeUpdate("INSERT INTO faculty (faculty_name, dept_name) VALUES ('Falak Qureshi', 'Commerce')");
            stmt.executeUpdate("INSERT INTO faculty (faculty_name, dept_name) VALUES ('Ayeza Khan', 'Biochemistry')");
            stmt.executeUpdate("INSERT INTO faculty (faculty_name, dept_name) VALUES ('Ruman Qureshi', 'Computer Science')");
